        ...
        <div v-if="forecast.length" class="forecast-grid">
          <article v-for="day in forecast" :key="day.date" class="forecast-card">
            <div class="forecast-card-header">
              ...
              <span class="forecast-icon" aria-hidden="true">{{ getWeatherDetails(day.code).icon }}</span>
            </div>
            <p class="forecast-description">{{ getWeatherDetails(day.code).description }}</p>
